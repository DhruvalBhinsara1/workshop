  ...
  export default function Hero() {
    return (
      <section className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between px-8 pt-20 relative overflow-hidden">
        {/* Text Section - More Centered */}
        <div className="w-full lg:w-[45%] text-center lg:text-left lg:ml-20">
          <h2 className="text-sm mb-2 italic">
            <span className="bg-red-100 text-red-600 px-1 rounded">What's New</span>
          </h2>
          <p className="text-sm text-white">New Arrivals!</p>
          <h1 className="text-3xl font-bold mt-2">
            <span className="text-red-600">New Sneakers!</span><span className="text-white"> are here Baby!</span> 
          </h1>
          ...
          <div className="w-full max-w-lg lg:max-w-3xl rounded-lg shadow-lg relative mt-10 mb-10 mr-20 z-10">
            <img
              src={SampleImage}
