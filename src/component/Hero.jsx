...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col lg:flex-row items-center justify-center px-4 pt-20 relative">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left">
        ...
        <div className="flex justify-center lg:justify-start gap-2 mt-4">
          ...
          <button className="px-4 py-2 border text-red-600 rounded shadow-red-700/50">View more →</button>
        </div>
      </div>
    </section>
  );
